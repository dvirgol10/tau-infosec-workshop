...
// a table which stores all the connection entries
conn_entry_t conn_tab[MAX_CONN_ENTRIES];
int num_conn_entries; // holdes the total number of entries in the table. < MAX_CONN_ENTRIES
